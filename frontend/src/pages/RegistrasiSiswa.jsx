    ...
    <div className="py-6 sm:py-8 px-3.5 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3.5 py-2 text-xs sm:text-sm font-semibold rounded-xl bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition-all shadow-2xs self-start sm:self-auto"
        >
          <RefreshCw
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="mb-4">
              ...
              <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-slate-950 border border-slate-700 flex items-center justify-center">
                ...
                <div className="absolute bottom-2 inset-x-0 text-center pointer-events-none">
                  <span className="bg-black/70 text-slate-200 text-[10px] font-medium px-2.5 py-0.5 rounded-full">
                    {currentSlot === 0
                      ? "Foto 1: Menghadap Lurus (Tampak Depan)"
                      : currentSlot === 1
                        ? "Foto 2: Sedikit Miring Kiri / Tersenyum"
                        : "Foto 3: Sedikit Miring Kanan"}
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                className="w-full mt-2.5 py-2.5 px-4 rounded-xl text-xs sm:text-sm font-bold bg-slate-900 hover:bg-slate-800 text-white flex items-center justify-center gap-2 transition-colors shadow-xs"
              >
            ...
            <button
              ...
              className="w-full py-3 px-6 rounded-xl font-bold text-xs sm:text-sm text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-md shadow-blue-500/20 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {submitting ? (
              ...
              <span>
                {reRecordingSiswa
                  ...
                  : `Simpan Siswa & Wajah (${samples.length} Sampel)`}
              </span>
            </button>
          </form>
        </div>
        ...
        <div className="lg:col-span-7 bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 flex flex-col">
          ...
          {/* Table Database Siswa */}
          <div className="overflow-x-auto overflow-y-auto max-h-[560px] flex-1 border border-slate-100 rounded-xl">
                      ...
                      >
                        ...
                        <td className="p-3">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            ...
                            <span
                              className={`text-[9px] font-bold px-2 py-0.5 rounded-md border ${jurInfo.badge}`}
                            >
                              {jurInfo.kode}
                            </span>
                          </div>
                        ...
                        <td className="p-3 text-right">
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-blue-600 hover:bg-blue-50 transition-colors border border-blue-200/60"
                            >
                            ...
                            <button
                              ...
                              className="p-1.5 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors border border-slate-200"
                            >
          ...
          <div className="bg-white rounded-2xl border border-slate-200 w-full max-w-sm overflow-hidden shadow-2xl p-6">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex-1 py-2 text-xs font-semibold rounded-xl text-slate-600 bg-slate-100 hover:bg-slate-200 transition-colors"
              >
                Batal
              </button>
              <button
                ...
                className="flex-1 py-2 text-xs font-bold rounded-xl text-white bg-rose-600 hover:bg-rose-700 transition-colors shadow-xs"
              >
                Hapus Siswa
              </button>
            </div>
            ...
            <form onSubmit={handleUpdateSiswa}>
              ...
              <div className="flex items-center gap-2.5">
                <button
                  type="button"
                  onClick={() => setEditingSiswa(null)}
                  className="flex-1 py-2 text-xs font-semibold rounded-xl text-slate-600 bg-slate-100 hover:bg-slate-200"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  className="flex-1 py-2 text-xs font-bold rounded-xl text-white bg-blue-600 hover:bg-blue-700"
                >
                  Simpan Perubahan
                </button>
              </div>
